...
VulkanGraphicsPipeline::VulkanGraphicsPipeline(VulkanRenderPass* renderPass, VulkanSwapchain* swapchain, VulkanLogicalDevice* logicalDevice) : logicalDevice(logicalDevice)
{
    VulkanShaderModule* vertexShader = new VulkanShaderModule(ResourceUtils::readFile("res/shaders/vert.spv"), logicalDevice);
    VulkanShaderModule* fragmentShader = new VulkanShaderModule(ResourceUtils::readFile("res/shaders/frag.spv"), logicalDevice);
